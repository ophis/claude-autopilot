...
> Status: **v0.8.2** — the build/fix surfaces are now **skills** (`skills/build`,
...
├── .claude-plugin/
│   ├── plugin.json               # name: autopilot (version 0.8.2)
...
**Updating:** this plugin uses explicit semver (currently `0.8.2`). A release bumps
