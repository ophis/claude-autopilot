...
> Status: **v0.8.7** — the build/fix surfaces are now **skills** (`skills/build`,
...
├── .claude-plugin/
│   ├── plugin.json               # name: autopilot (version 0.8.7)
...
**Updating:** this plugin uses explicit semver (currently `0.8.7`). A release bumps
